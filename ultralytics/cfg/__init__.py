...
TASKS = 'detect', 'segment', 'classify', 'pose', 'reid', 'idpose'
TASK2DATA = {'detect': 'coco8.yaml', 'segment': 'coco8-seg.yaml', 'classify': 'imagenet10', 'pose': 'coco8-pose.yaml', 'reid': 'coco8.yaml', 'idpose': 'coco8-pose.yaml'}
TASK2MODEL = {
    'detect': 'yolov8n.pt',
    'segment': 'yolov8n-seg.pt',
    'classify': 'yolov8n-cls.pt',
    'pose': 'yolov8n-pose.pt',
    'reid': 'yolov8n-reid.pt',
    'idpose': 'yolov8n-idpose.pt'}
TASK2METRIC = {
    'detect': 'metrics/mAP50-95(B)',
    'segment': 'metrics/mAP50-95(M)',
    'classify': 'metrics/accuracy_top1',
    'pose': 'metrics/mAP50-95(P)',
    'reid': 'metrics/mAP50-95(B)',
    'idpose': 'metrics/mAP50-95(P)'}
